...
struct AcronymsController: RouteCollection {
  ...
  func boot(routes: RoutesBuilder) throws {
    ...
    tokenAuthGroup.post(":acronymID", "categories", ":categoryID",
                        use: addCategoriesHandler)
    tokenAuthGroup.delete(":acronymID", "categories", ":categoryID",
                          use: removeCategoryHandler(_:))
  }
...
//2860AF89-7F36-4574-8ECF-B97930B9EE8C
